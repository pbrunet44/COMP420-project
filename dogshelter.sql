...
insert into employees values(6001, 31, 8, 'Shelly', 'Hines','2019-03-05', null);
insert into employees values(6002, 31, 8, 'Annette', 'Boisvert','2019-04-15', null);
insert into employees values(6003, 31, 8, 'Gordon', 'Ring','2019-03-21', null);
insert into employees values(6004, 31, 8, 'Harold', 'Bejarano','2019-04-13', null);
...
insert into employees values(5001, 9, 8, 'Shannon', 'Perez','2019-03-05', null);
insert into employees values(5002, 9, 8, 'Jimmy', 'Jennings','2019-04-15', null);
insert into employees values(5003, 9, 8, 'Lisa', 'Popp','2019-03-21', null);
insert into employees values(5004, 9, 8, 'Rachel', 'McPherson','2019-04-13', null);
...
insert into employees values(4001, 27, 8, 'Deborah', 'Driscoll','2019-03-05', null);
insert into employees values(4002, 27, 8, 'Esther', 'Sellers','2019-04-15', null);
insert into employees values(4003, 27, 8, 'Dustin', 'Turner','2019-03-21', null);
insert into employees values(4004, 27, 8, 'Gregory', 'Snyder','2019-04-13', null);
...
insert into employees values(3001, 5, 8, 'Wanda', 'Dempsey','2019-03-05', null);
insert into employees values(3002, 5, 8, 'Jennette', 'Duncan','2019-04-15', null);
insert into employees values(3003, 5, 8, 'Ellen', 'Brown','2019-03-21', null);
insert into employees values(3004, 5, 8, 'Robert', 'Veach','2019-04-13', null);
...
insert into employees values(2001, 24, 8, 'Andrew', 'Giddens','2019-03-05', null);
insert into employees values(2002, 24, 8, 'Elisabeth', 'McGuire','2019-04-15', null);
insert into employees values(2003, 24, 8, 'Aaron', 'Ballantyne','2019-03-21', null);
insert into employees values(2004, 24, 8, 'Miriam', 'Wilson','2019-04-13', null);
...
insert into employees values(1001,13, 8, 'Lindsey', 'Richardson','2019-03-05', null);
insert into employees values(1002,13, 8, 'Wesley', 'Rodriguez','2019-04-15', null);
insert into employees values(1003,13, 8, 'Allen', 'Beaudry','2019-03-21', null);
insert into employees values(1004,13, 8, 'Barbara', 'Cole','2019-04-13', null);
